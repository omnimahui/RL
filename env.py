...
class Env:
    def __init__(self, data, data_close, action_name, device="cuda", gamma=0.7, n_step=4, batch_size=50, start_index_reward=0,
                 transaction_cost=0):
        """
        ...
        self.n_step = n_step
        self.gamma = gamma
        self.close_price = list(data_close)
        ...
        self.data_preprocessed = self.data.values
